...
const HomePage = (params) => {
    ...
    const getComponentById = (componentId) => {
        ...
        // if (rootComponent.component.type === 'condition') {
        //     // get new rootList from
        // }
        ...
        if (true) {
            if (rootComponent.type && !rootComponent.children) {
                if (rootComponent.type === 'button' && rootComponent.options.variable === 'show_weather' && rootComponent.options.value === 'show') {
                    console.log('****** rootComponent.type BUTTON show_weather show FOUND!')
                    ...
                    console.log('****** rootComponent.type BUTTON show_weather hide FOUND!')
                    return getShowButtonComponent(rootComponent.options.value);
                } else if (rootComponent.type === 'button' && rootComponent.options.variable === 'location') {
                    
                    // console.log('^^^^^^^^^ button:location:', rootComponent)
                    // return getLocationSelectComponent(rootComponent.options.value);
                    ...
                    console.log('****** rootComponent.type WEATHER FOUND!')
                    ...
                    return <div key={uuid()}>
                        ...
                        {list.components.map((componentId) => {
                            ...
                            if (rootComponent.type === 'condition') {
                                ...
                                // console.log('=====> from condition, rootComponent.children, subList:', rootComponent.children, subList)
